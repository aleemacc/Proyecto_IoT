...
En este circuito se hace una separacion entre la alimentacion del motor y el control del mismo, debido a que el uC no es capaz de suministrar la suficiente corriente como para operar el motor.
...
- Luego, dentro del loop, definimos el resto del comportamiento, de manera que al pulsarse alguno de los botones límites el motor se para.
